...
struct FilterButtonsView: View {
    ...
    @Binding var confirmationForDeletionOfCompletedTimers: Bool
    let totalCompleted: Int
    let totalNotCompleted: Int
    let totalFlagged: Int
    let deleteCompletedTimers: () -> Void
            ...
            LazyHStack {
                ...
                Circle()
                    ...
                    .opacity(0.5)
                            ...
                            // to toggle the completed timers
                            Button {
                ...
                .clipShape(Capsule())
                                            ...
                                            // to toggle the not completed timers
                            Button {
                ...
                // confirmation for the deleting of the completed timers
                Button {
                    confirmationForDeletionOfCompletedTimers = true
                } label: {
                    Image(systemName: "trash.fill")
                }.confirmationDialog("Are you sure you want to Delete all the Completed Timers?", isPresented: $confirmationForDeletionOfCompletedTimers, titleVisibility: .visible, actions: {
                    Button("Delete", role: .destructive, action: deleteCompletedTimers)
